		...
		<div className="flex flex-col min-h-screen bg-secondary/10">
			...
			<header className="sticky top-0 z-50 bg-white shadow-md">
				<div className="container mx-auto px-4 py-4 flex items-center justify-between">
					...
					<nav className="hidden md:flex items-center space-x-8">
						<Link href="#services" className="text-slate-700 hover:secondary font-medium transition-colors">
							Services
						</Link>
						<Link href="#locations" className="text-slate-700 hover:secondary font-medium transition-colors">
							Locations
						</Link>
						{/* <Link
							href="#pricing"
						...
						<Link href="#gallery" className="text-slate-700 hover:secondary font-medium transition-colors">
							Gallery
						</Link>
						<Link href="#testimonials" className="text-slate-700 hover:secondary font-medium transition-colors">
							Testimonials
						</Link>
						<Link href="#contact" className="text-slate-700 hover:secondary font-medium transition-colors">
							Contact
						</Link>
						<AuthButtons />
					</nav>
			...
			<section className="relative bg-gradient-to-b from-amber-50 to-white overflow-hidden pt-12 pb-24">
				...
				<div className="absolute top-0 left-0 w-full h-full overflow-hidden">
					<BackgroundElement type="paws" className="absolute top-10 left-10 opacity-10" fill="#F97316" />
					<BackgroundElement type="paws" className="absolute bottom-10 right-10 opacity-10" fill="#84CC16" />
				</div>

				<div className="container mx-auto px-4 relative z-10">
					<div className="flex flex-col md:flex-row items-center gap-12">
						<div className="md:w-1/2">
							<Badge className="primary-bg mb-4 px-3 py-1 text-sm rounded-full white">North London, Hertfordshire and St Albans</Badge>
							...
							<p className="text-slate-600 mb-6 text-lg leading-relaxed">
								When a walk is not enough and daycare is too much...try our fun play mornings
							</p>
							<div className="flex flex-wrap gap-4 mb-8">
								...
								<div className="flex items-center">
									...
									<span className="text-slate-700">Canine first aid trained</span>
								</div>
								<div className="flex items-center">
									<div className="primary-bg p-2 rounded-full mr-3">
										<Check className="h-5 w-5 secondary" />
									</div>
									<span className="text-slate-700">Fenced and secure site</span>
								</div>
							</div>
							<Button
								asChild
			...
			<section id="services" className="py-24 bg-white relative overflow-hidden">
				<div className="absolute left-0 top-0 w-full">
					<BackgroundElement type="wave" className="w-full" fill="#FEF3C7" />
				</div>
				...
				<div className="container mx-auto px-4 relative z-10">
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
						<Card className="border-0 shadow-lg rounded-3xl overflow-hidden">
							...
							<CardContent className="pt-6">
								<div className="aspect-video relative mb-6 overflow-hidden rounded-xl">
									<Image src="/images/dog3.jpeg?height=200&width=400" alt="Dog playing with staff" fill className="object-cover" />
								</div>
								<ul className="space-y-3">
									...
									<li className="flex items-start">
										...
										<span className="text-slate-700">Parking on site</span>
									</li>
									<li className="flex items-start">
										<div className="primary-bg p-1 rounded-full mr-3 mt-0.5">
											<Check className="h-4 w-4 secondary" />
							...
							<CardContent className="pt-6">
								...
								<ul className="space-y-3">
									<li className="flex items-start">
										...
										<span className="text-slate-700">Social play with dogs of their own energy levels</span>
									</li>
									<li className="flex items-start">
										<div className="primary-bg p-1 rounded-full mr-3 mt-0.5">
											<Check className="h-4 w-4 secondary" />
										</div>
										<span className="text-slate-700">Using all their senses</span>
									</li>
									<li className="flex items-start">
										<div className="primary-bg p-1 rounded-full mr-3 mt-0.5">
											<Check className="h-4 w-4 secondary" />
										</div>
										<span className="text-slate-700">Free pick up & drop off</span>
									</li>
									<li className="flex items-start">
										<div className="primary-bg p-1 rounded-full mr-3 mt-0.5">
											<Check className="h-4 w-4 secondary" />
						...
						<Card className="border-0 shadow-lg rounded-3xl overflow-hidden">
							...
							<CardContent className="pt-6">
								<div className="aspect-video relative mb-6 overflow-hidden rounded-xl">
									<Image src="/images/dog5.jpeg?height=200&width=400" alt="Dog catching ball" fill className="object-cover" />
								</div>
								<ul className="space-y-3">
									<li className="flex items-start">
										<div className="primary-bg p-1 rounded-full mr-3 mt-0.5">
									...
									<li className="flex items-start">
										...
										<span className="text-slate-700">Discounts for multiple dogs</span>
									</li>
									<li className="flex items-start">
										<div className="primary-bg p-1 rounded-full mr-3 mt-0.5">
											<Check className="h-4 w-4 secondary" />
			...
			<section className="py-24 bg-gradient-to-br from-slate-800 to-slate-900 text-white relative overflow-hidden">
				{/* Background elements */}
				<BackgroundElement type="paws" className="absolute top-0 left-0 opacity-10" fill="white" />
				<BackgroundElement type="paws" className="absolute bottom-0 right-0 opacity-10" fill="white" />

				<div className="container mx-auto px-4 text-center relative z-10">
					<Badge className="bg-white text-slate-800 mb-4 px-3 py-1 text-sm rounded-full">Join Our Pack</Badge>
					<h2 className="text-3xl md:text-4xl font-bold mb-6 font-display">Ready for Tail-Wagging Adventures?</h2>
					<p className="mb-8 max-w-2xl mx-auto text-lg opacity-90">
						We pick up your dog and take them to our secure and fully fenced site.
					</p>

					<p className="mb-8 max-w-2xl mx-auto text-lg opacity-90">
						Your dog spends 2+ hours on site with us where they will participate in social play with dogs of their own energy levels
					</p>
					<p className="mb-8 max-w-2xl mx-auto text-lg opacity-90">
						They will use all their senses while walking and exploring with us and their doggy friends
					</p>
					<p className="mb-8 max-w-2xl mx-auto text-lg opacity-90">
						This all takes place in the stunning Hertfordshire countryside with our 'dog nut' team who are all professionally trained and
						super motivated to do what they do.
					</p>
					<h3 className="text-1xl md:text-2xl font-bold mb-6 font-display">All staff are DBS checked and canine first aid trained</h3>
						...
						<div className="group max-w-[500px] mx-auto">
							<div className="rounded-3xl overflow-hidden shadow-lg">
								<div className="relative">
									...
									<div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent"></div>
									<div className="absolute bottom-0 left-0 p-4 text-white">
										<h3 className="font-bold text-xl">Hertfordshire</h3>
										<p className="flex items-center mt-1 text-sm opacity-90">
											<MapPin className="h-4 w-4 mr-1" />
			...
			<section id="gallery" className="py-24 bg-amber-50">
				<div className="container mx-auto px-4">
					<div className="text-center mb-16">
						<Badge className="primary-bg mb-4 px-3 py-1 text-sm rounded-full white">Happy Pups</Badge>
						<h2 className="text-3xl md:text-4xl font-bold text-slate-800 mb-4 font-display">Gallery</h2>
						<p className="text-slate-600 max-w-2xl mx-auto">See the joy and excitement of our furry clients</p>
					</div>
							...
							<CardContent className="pt-8">
								<div className="flex flex-col items-center mb-6">
									...
									<div className="text-center">
										<p className="font-bold text-slate-800 text-lg">Samantha & Bella</p>
										<p className="text-slate-500 text-sm">North London</p>
									</div>
								</div>
						...
						<Card className="border-0 shadow-lg rounded-3xl overflow-hidden">
							<CardContent className="pt-8">
								<div className="flex flex-col items-center mb-6">
									...
									<div className="text-center">
										<p className="font-bold text-slate-800 text-lg">James & Max</p>
										<p className="text-slate-500 text-sm">West London</p>
									</div>
								</div>
			...
			<section id="contact" className="py-24 bg-gradient-to-br from-slate-800 to-slate-900 text-white relative overflow-hidden">
				<div className="container mx-auto px-4">
					<div className="max-w-xl mx-auto text-center mb-12">
						<h2 className="text-3xl md:text-4xl font-bold mb-4 font-display">Contact Us</h2>
			...
			<footer className="bg-white pt-16 pb-8">
				<div className="container mx-auto px-4">
					<div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
						...
						<div>
							<h3 className="font-bold text-slate-800 mb-6 text-lg">Quick Links</h3>
							<ul className="space-y-3">
								<li>
									<Link href="#services" className="text-slate-600 hover:secondary transition-colors">
										Our Services
									</Link>
								</li>
								<li>
									<Link href="#locations" className="text-slate-600 hover:secondary transition-colors">
										Locations
									</Link>
								</li>
								<li>
									<Link href="#pricing" className="text-slate-600 hover:secondary transition-colors">
										Pricing
									</Link>
								</li>
								<li>
									<Link href="#gallery" className="text-slate-600 hover:secondary transition-colors">
										Gallery
									</Link>
								</li>
								<li>
									<Link href="#testimonials" className="text-slate-600 hover:secondary transition-colors">
										Testimonials
									</Link>
								</li>
							</ul>
						...
						<div>
							<h3 className="font-bold text-slate-800 mb-6 text-lg">Contact Us</h3>
							<ul className="space-y-3">
								<li className="flex items-start">
									<MapPin className="h-5 w-5 secondary mr-3 flex-shrink-0 mt-0.5" />
									<span className="text-slate-600">Rectory Road, Shenley, Hertfordshire</span>
								</li>
								<li className="flex items-start">
									<Phone className="h-5 w-5 secondary mr-3 flex-shrink-0 mt-0.5" />
									<span className="text-slate-600">020 1234 5678</span>
								</li>
								<li className="flex items-start">
								...
								<li className="flex items-start">
									...
									<span className="text-slate-600">Mon-Fri: 7am-7pm</span>
								</li>
							</ul>
						</div>
